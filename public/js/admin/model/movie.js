...
class Movie {
    ...
    buildEditModal = () => {
        ...
        return (
            ...
            + buildSelect("The loai", "movie-type", this.type, options, DISABLED.NO)
    ...
    buildNewModal = () => {
        ...
        return (
            ...
            + buildSelect("The loai", "movie-type", 1, options, DISABLED.NO)
    ...
    buildInfoModal = () => {
        ...
        return (
            ...
            + buildSelect("The loai", "movie-type", this.type, options, DISABLED.YES)
